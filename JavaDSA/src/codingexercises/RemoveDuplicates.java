...
//The task is to write a method named removeDuplicates, that removes all duplicate occurrences of integers 
//from a sorted array in-place such that each unique element appears only once.
//
...
//
//The method should not allocate extra space for another array, 
//you must do this by modifying the input array in-place with O(1) extra memory (this means you cannot use another data structure like a set).
//
