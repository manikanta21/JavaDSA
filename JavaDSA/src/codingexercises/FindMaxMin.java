...
//The function should iterate through the array to find the maximum and minimum numbers. In this case, the maximum number is 9, 
//and the minimum number is 1. Hence, the method should return [9, 1].
//Additional Notes
//
//The main method provides some test cases to check the solution's correctness. 
//It is important to note that the method should work correctly with negative numbers and zeros. Also, 
...
public class FindMaxMin {
	...
	public static int[] findMaxMin(int[] myList) {
		...
		return new int[] {myList[myList.length-1],myList[0]};
	}
	...
	public static void main(String args[]) {
        ...
        int[] results11 = findMaxMin2(myList1);
        System.out.println("Test case 1: MaxMin: " + Arrays.toString(result1)); // prints "[9, 1]"
        System.out.println("Test case 1: MaxMin: " + Arrays.toString(results11)); // prints "[9, 1]"
